...
var (
	_ datasource.DataSource              = &LksClustersDataSource{}
	_ datasource.DataSourceWithConfigure = &LksClustersDataSource{}
)

func NewLksClustersDataSource() datasource.DataSource {
	return &LksClustersDataSource{}
}

type LksClustersDataSource struct {
	client *latitudeshgosdk.Latitudesh
}

type LksClustersDataSourceModel struct {
...
func (d *LksClustersDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_lks_clusters"
}

func (d *LksClustersDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *LksClustersDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *LksClustersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data LksClustersDataSourceModel
	...
	if res != nil && res.LksClusters != nil {
		for _, c := range res.LksClusters.Data {
			if lksMatchesStatus(c, statusFilter) {
...
// non-empty one.
func lksMatchesStatus(c components.LksClusterData, want string) bool {
	if want == "" {
		return true
	}
