---
page_title: "latitudesh_virtual_network Resource - latitudesh"
subcategory: ""
description: |-
...
- `site` (String) The site to deploy the virtual network (case-insensitive)
...
- `assignments_count` (Number) Number of devices assigned to the virtual network
- `id` (String) Virtual Network identifier
- `region` (String) The region where the virtual network is deployed
- `vid` (Number) VLAN ID of the virtual network
